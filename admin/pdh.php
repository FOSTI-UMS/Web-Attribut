...
<head>
    ...
    <title>ATRIBUT FOSTI - Rekap Pemesanan PDH</title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php
                                    $i = 1;
                                    $sql = "SELECT * FROM pdh INNER JOIN user ON nim=username";
                                    ...
                                    ?>
                                        ...
                                        <td style="text-align:center"><?php echo $mahasiswa['nickname']; ?></td>
                                        <td style="text-align:center"><?php echo $mahasiswa['size']; ?></td>
                                        </tr>
                                    <?php
                                        }
                                    }    
