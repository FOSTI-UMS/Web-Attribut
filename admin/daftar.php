...
<head>
    ...
    <title>ATRIBUT FOSTI - Rekap Pemesanan Atribut</title>
    <!-- Favicon-->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-green">
                            <h2>
                                Daftar Rekap Pemesanan Atribut
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php
                                    $i = 1;
                                    $sql = "SELECT * FROM pemesanan INNER JOIN user ON nim=username";
                                    ...
                                    ?>
                                        ...
                                        <td style="text-align:center"><?php echo $mahasiswa['pdh']; ?></td>
                                        <td style="text-align:center"><?php echo $mahasiswa['idcard']; ?></td>
                                        <td style="text-align:center"><?php echo $mahasiswa['kaos']; ?></td>
                                        <td style="text-align:center"><?php echo $mahasiswa['total']; ?></td>
                                        <td style="text-align:center"><?php echo $mahasiswa['sp']; ?></td>
                                        </tr>
                                    <?php
                                        }
                                    }    
